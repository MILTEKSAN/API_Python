...
class CNCClientApp:
    def __init__(self, root):
        ...
        self.enable_button_state = tk.BooleanVar(value=False) # YENİ: Enable butonu durumu
    ...
    def create_widgets(self):
        ...
        self.enable_button.grid(row=3, column=1, columnspan=2, pady=5, padx=5, sticky="ew")
    ...
    # YENİ: Enable butonunun toggle fonksiyonu
    ...
    def update_gui_state(self):
        ...
        widget_list = [self.write_axis_button, self.read_all_button, self.read_clear_all_button,
                       ...
                       self.oscillation_button, self.enable_button] + self.write_dword_sliders + self.single_write_buttons
